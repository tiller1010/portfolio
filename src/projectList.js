  ...
  render(){
    return(
      <div className='window'>
        ...
        <h3 className='projectFrame'>The family tree project also utilizes an object oriented style, but this project allows for more objects to be created by the user. The user may even upload an image by file or URL. When clicked, a person box will display that person's properties, and a line will be drawn on the canvas, connecting child to parent. This project also includes a feature that uses regular expressions to search for all mothers and fathers.
        ...
        <h3 className='projectFrame'>This website template includes multiple pages and a few neat features such as an image slider, a contact form, and an animated menu on mobile devices. The website is responsive and should change the appearance of the navigation bar if viewed on a devices with smaller displays.
